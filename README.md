...
You will also need R v.3.5.1, although again some packages may have backwards compatibility. R analyses require the following packages: scImpute v.0.0.9, SAVER v.1.1.1, doSNOW v.1.0.16, doParallel v.1.0.14, Seurat v.3.0.0., ggpubr v.0.2, RColorBrewer v.1.1.2, ggplot2 v.2.3.1.1, topGO v.2.34.0, dplyr v.0.8.0.1, MAST v.1.8.2, and Rmagic v.1.5.0. In the R script, the installation lines are commented out but can easily be added depending on the packages your machine already has installed.
